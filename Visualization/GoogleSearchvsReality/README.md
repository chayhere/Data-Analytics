...
## Overview / What I Did
- Compared how people search on Google with what actually happens in the real world — Tesla stock prices, Bitcoin value, and unemployment rates.
...
- Showed that people’s online behavior can act as an early signal for market and economic changes.

## Tools / Skills Used
- Python: pandas, matplotlib
- Data Cleaning: dates, merging, monthly grouping
- Analysis: trend matching, real-world comparison
- Visualization: time-series, dual-axis charts
